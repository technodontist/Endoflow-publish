...
-- 1.1 Extend appointment_requests table with notification tracking
ALTER TABLE api.appointment_requests ADD COLUMN IF NOT EXISTS notification_sent BOOLEAN DEFAULT FALSE;
ALTER TABLE api.appointment_requests ADD COLUMN IF NOT EXISTS assigned_to UUID REFERENCES api.assistants(id);
