  ...
  const handleConfirmAppointment = async () => {
    if (selectedSlot && selectedPatient) {
      ...
      try {
        ...
        console.log(
          `[v0] Booking appointment for ${selectedPatient.name} on ${selectedSlot.day} at ${selectedSlot.time}`,
        )
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-[#005A9C] mb-2">New Appointment</h1>
          ...
          <div className="mt-6 flex justify-center">
            <Button
              ...
              className="bg-[#009688] hover:bg-[#009688]/90 text-white px-8 py-3 text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
              size="lg"
            >
              {!selectedPatient && !selectedSlot
                ? "Select Patient & Time Slot"
                : !selectedPatient
