-- =============================================
-- ENDOFLOW - FIX RLS INFINITE RECURSION
-- =============================================
-- This script fixes the infinite recursion error in RLS policies
-- The issue is circular dependencies in policy checks
...
-- CONSULTATIONS TABLE - Simple role-based policies
...
-- TOOTH DIAGNOSES TABLE - Simple policies
